...
it('keeps cashbook detail panel aligned to the KV expanded row structure', () => {
  ...
  expect(cssRule('.finance-cashbook-detail-actions .button')).toContain('display: inline-flex')
  expect(cssRule('.finance-cashbook-detail-actions .button')).toContain('align-items: center')
  expect(cssRule('.finance-cashbook-detail-actions .button')).toContain('flex-wrap: nowrap')
  expect(cssRule('.finance-cashbook-detail-actions .button')).toContain('white-space: nowrap')
