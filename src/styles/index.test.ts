...
it('places finance voucher actions at the right edge of the finance action row', () => {
  ...
  expect(cssRule('.management-page-actions .button')).toContain('display: inline-flex')
  expect(cssRule('.management-page-actions .button')).toContain('align-items: center')
  expect(cssRule('.management-page-actions .button')).toContain('flex-wrap: nowrap')
  expect(cssRule('.management-page-actions .button')).toContain('white-space: nowrap')
...
it('keeps cashbook detail panel aligned to the KV expanded row structure', () => {
  ...
  expect(cssRule('.management-detail-meta-grid div,\n.management-detail-meta-rows > div')).toContain('border-bottom: 1px solid var(--color-border-muted)')
  ...
  expect(cssRule('.management-detail-footer-actions .button')).toContain('gap: var(--space-1)')
