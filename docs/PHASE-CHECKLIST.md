...
| Active coordination board | Không có item đang mở trong [PROJECT-COORDINATION.md](./PROJECT-COORDINATION.md) |
| Review issue còn mở | `REV-2026-07-03-003` — bundle production vượt ngưỡng cảnh báo Vite; defer performance cleanup |
| Docs cleanup | Đã chuẩn hoá index/metadata; checklist này là nguồn xem trạng thái sống |
| Current product/inventory/POS direction | Hoàn tất Hàng hóa → Kiểm kho hàng thường → Cuộn/tấm/khui object-level → POS trừ kho thật |
...
| Product/Inventory/POS completion | Cao | Plan: [2026-07-07-products-inventory-pos-completion.md](./superpowers/plans/2026-07-07-products-inventory-pos-completion.md). Không còn luồng song song phải né, có thể triển khai trực tiếp theo thứ tự |
...
| Bundle size cleanup | Thấp/trì hoãn | Đang track ở `REV-2026-07-03-003`; build vẫn pass, chỉ cảnh báo Vite |
