...
| 3 | Nghiệp vụ | `03-BUSINESS-NghiepVu/` | 🔨 Đang làm | Dev, người viết logic |
| 4 | Cơ sở dữ liệu | `04-DATABASE/` | 🔨 Foundation đã chốt | DBA, backend dev |
| 5 | Máy chủ & API | `05-BACKEND-MayChu/` | 🔨 Foundation đã chốt | Backend dev |
| 6 | Tích hợp bên ngoài | `06-INTEGRATION-KetHop/` | ⬜ Chưa | Dev, người kết nối |
| 7 | Triển khai | `07-DEPLOYMENT-TrienKhai/` | 🔨 Baseline đã chốt | DevOps, sysadmin |
...
| 3 | [03-BUSINESS-NghiepVu](../03-BUSINESS-NghiepVu/_RULES.md) | Quy tắc nghiệp vụ cốt lõi | 🔨 Đang làm |
| 4 | [04-DATABASE](../04-DATABASE/README.md) | Sơ đồ quan hệ, định nghĩa bảng | 🔨 Foundation đã chốt |
| 5 | [05-BACKEND-MayChu](../05-BACKEND-MayChu/README.md) | API, xác thực, quyền | 🔨 Foundation đã chốt |
| 6 | [06-INTEGRATION-KetHop](../06-INTEGRATION-KetHop/_RULES.md) | Tích hợp máy in, Zalo, QR | ⬜ Chưa |
| 7 | [07-DEPLOYMENT-TrienKhai](../07-DEPLOYMENT-TrienKhai/_RULES.md) | Triển khai, CI/CD, monitoring | 🔨 Baseline đã chốt |

Roadmap điều phối phát triển liên tầng: [DEVELOPMENT-PLAN.md](../DEVELOPMENT-PLAN.md).
