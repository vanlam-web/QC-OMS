...
| **Loại 3 (Combo/BOM)** | Nếu BOM đã cấu hình đủ, trừ từng vật tư thành phần theo BOM. Nếu BOM chưa đủ/chưa chốt, chỉ lưu snapshot dòng combo và cảnh báo, không tự deep-scan/trừ vật tư con |

Combo/BOM trong MVP không được làm checkout thất bại chỉ vì thiếu cấu hình vật tư con, trừ khi phase BOM sau này chốt quy tắc bắt buộc khác. Giá bán combo độc lập với tổng giá vật tư thành phần.
