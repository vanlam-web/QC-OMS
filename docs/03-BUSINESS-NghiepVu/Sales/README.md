...
BOM/Combo đã có Source of Truth nghiệp vụ riêng tại [BOM-RULES.md](../BOM/BOM-RULES.md). Ranh giới chính:
...
- Combo lồng nhiều cấp cần version, snapshot, chống vòng lặp và deep-scan backend.
