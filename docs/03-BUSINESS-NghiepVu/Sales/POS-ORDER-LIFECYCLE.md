...
Hóa đơn nháp trên POS là trạng thái làm việc tạm thời của phiên trình duyệt đang bán hàng.

Nháp chưa có mã chứng từ chính thức và chưa phát sinh doanh thu, kho, sổ quỹ hoặc công nợ.

### BR-ORD-02: Nháp được giữ cục bộ theo trình duyệt/thiết bị

Mỗi trình duyệt/thiết bị đang dùng POS có bộ nháp riêng.

Nháp đang mở trên thiết bị A không tự xuất hiện trên thiết bị B.
...
Một khách hàng có thể có nhiều hóa đơn nháp cùng lúc trên cùng trình duyệt/thiết bị.
...
2. Nháp trên trình duyệt/thiết bị này không tự xuất hiện trên trình duyệt/thiết bị khác.
3. Một khách hàng có thể có nhiều nháp trên cùng trình duyệt/thiết bị.
