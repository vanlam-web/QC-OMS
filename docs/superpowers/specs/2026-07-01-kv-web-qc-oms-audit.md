...
1. Employee/permissions: chỉ làm phần tài khoản nhân viên và quyền tối thiểu để vận hành POS/kho/quỹ; không làm chấm công/lương/hoa hồng.
2. Purchase/Supplier: đã có draft, để sau MVP nếu chưa chốt nhập kho vật lý theo cuộn/tấm và giá vốn.
3. PriceBook/Customer/SalesDocuments/Reports/Inventory Adjustments: đã có PRD-UX nền; sau này bổ sung khi implementation bắt đầu phase tương ứng.
