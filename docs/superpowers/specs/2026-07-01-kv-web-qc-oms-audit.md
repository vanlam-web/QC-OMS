...
- Bỏ khỏi scope hiện tại: đặt hàng KiotViet, trả hàng bán, trả hàng nhập, vận đơn/COD, bán giao hàng, VAT/HĐĐT, kênh bán online, thương hiệu retail, mua dịch vụ riêng.
...
1. Inventory adjustments: nâng draft hủy/điều chỉnh vật tư thành PRD-UX tối giản, tập trung tấm lỡ dưới `0.3m2`, hủy hỏng và lịch sử tồn.
2. Reports tiếp theo: sau End Of Day, đặc tả báo cáo bán hàng, công nợ, hàng hóa/tồn kho và tài chính ở mức quản trị.
3. Employee/permissions: chỉ làm phần tài khoản nhân viên và quyền tối thiểu để vận hành POS/kho/quỹ; không làm chấm công/lương/hoa hồng.
4. Purchase/Supplier: đã có draft, để sau MVP nếu chưa chốt nhập kho vật lý theo cuộn/tấm và giá vốn.
5. PriceBook/Customer/SalesDocuments: đã có PRD-UX nền; sau này bổ sung khi implementation bắt đầu phase tương ứng.
