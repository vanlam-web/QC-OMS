...
1. Purchase/Supplier: đã có draft, để sau MVP nếu chưa chốt nhập kho vật lý theo cuộn/tấm và giá vốn.
2. PriceBook/Customer/SalesDocuments/Reports/Inventory Adjustments/System permissions: đã có PRD-UX nền; sau này bổ sung khi implementation bắt đầu phase tương ứng.
