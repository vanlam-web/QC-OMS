...
1. Reports tiếp theo: sau End Of Day, đặc tả báo cáo bán hàng, công nợ, hàng hóa/tồn kho và tài chính ở mức quản trị.
2. Employee/permissions: chỉ làm phần tài khoản nhân viên và quyền tối thiểu để vận hành POS/kho/quỹ; không làm chấm công/lương/hoa hồng.
3. Purchase/Supplier: đã có draft, để sau MVP nếu chưa chốt nhập kho vật lý theo cuộn/tấm và giá vốn.
4. PriceBook/Customer/SalesDocuments: đã có PRD-UX nền; sau này bổ sung khi implementation bắt đầu phase tương ứng.
