...
- Tab thông tin có mã/tên khách, người tạo, ngày tạo `16/06/2026`, nhóm khách, SĐT/email/địa chỉ/ngày sinh/giới tính, thông tin xuất hóa đơn và ghi chú.
...
- Bỏ khỏi MVP: đặt hàng KiotViet, trả hàng bán, trả hàng nhập, vận đơn/COD, bán giao hàng, VAT/HĐĐT, kênh bán online, thương hiệu retail, mua dịch vụ riêng.
...
1. Price Book PRD-UX: bảng giá chung, bảng giá theo nhóm, thao tác cập nhật giá.
2. Reports: đã có draft, ưu tiên báo cáo cuối ngày sau khi Finance/đối soát ổn định.
3. Purchase/Supplier: đã có draft, chưa làm MVP nếu Owner chưa chốt nhập kho vật lý theo cuộn/tấm và giá vốn.
4. Inventory adjustments/returns: đã có draft, cần giữ tối giản theo hướng điều chỉnh tồn/hủy vật tư, không làm trả hàng bán trong MVP.
5. VAT/employee modules: chỉ audit để xác nhận bỏ/defer, không đưa vào MVP nếu không có nghiệp vụ thật.
