...
Báo cáo cuối ngày là báo cáo động theo dữ liệu hiện tại. Nếu hóa đơn, phiếu thu/chi, công nợ hoặc chứng từ sửa/hủy được cập nhật hợp lệ, số liệu báo cáo thay đổi theo. QC-OMS hiện tại không có thao tác khóa ngày/chốt báo cáo thành bản bất biến.
...
1. Người dùng xem được báo cáo hôm nay và chọn được khoảng ngày tùy chỉnh.
...
8. Không có nút khóa ngày/chốt báo cáo trong QC-OMS hiện tại.
