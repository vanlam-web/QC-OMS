...
| Khách lẻ | Hóa đơn gán vào khách mặc định `KH000001 - Khách lẻ` |
...
Quy tắc dữ liệu: báo cáo không dùng nhóm `customer_id = null` cho bán lẻ. Nếu nhân viên không chọn khách khi lưu báo giá/hóa đơn, backend gán chứng từ vào `KH000001`, nên doanh thu, lịch sử và công nợ khách lẻ được cộng về hồ sơ này.
