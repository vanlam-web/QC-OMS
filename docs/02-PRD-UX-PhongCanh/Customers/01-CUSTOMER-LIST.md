...
- Hồ sơ khách MVP có trường `Địa chỉ` dạng một dòng nhập tự do. Không tách thành khu vực, phường/xã, quận/huyện hoặc tỉnh/thành trong MVP vì rườm rà cho thao tác bán hàng.
...
- địa chỉ nhận hàng nhiều dòng/nhiều khu vực nếu chưa làm module giao hàng

`MST` và `Địa chỉ` không cần là cột mặc định trên danh sách chính nếu làm chật bảng, nhưng phải có trong form tạo/sửa và chi tiết khách.
...
- Form tạo khách mở dạng modal/ô riêng tham khảo KiotViet, không nằm lộ inline trên đầu danh sách.
- Modal có vùng nội dung cuộn được và footer hành động cố định gồm `Bỏ qua` và `Lưu`.
- Tên khách hàng bắt buộc.
- Mã khách hàng bắt buộc về dữ liệu, nhưng nếu người dùng để trống thì hệ thống tự sinh.
- SĐT không bắt buộc.
- MST không bắt buộc.
- Địa chỉ không bắt buộc, chỉ là một dòng tự nhập. Sau này nếu cần có thể thêm gợi ý địa chỉ, nhưng không mở bộ trường khu vực/phường/xã trong MVP.
