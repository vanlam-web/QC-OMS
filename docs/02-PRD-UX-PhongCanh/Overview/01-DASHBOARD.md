...
Hoạt động gần đây hiển thị các sự kiện vận hành quan trọng và nằm ở cột phải dạng sticky trên desktop. Khi cuộn dashboard, khối này giữ vị trí để người quản lý luôn thấy dòng thời gian mới nhất.
