...
| Hàng đợi máy sản xuất | Lắng nghe sự kiện máy sản xuất → K02-D | [→ POS-TABLES.md §5](../../../04-DATABASE/Sales/POS-TABLES.md#5-supabase-realtime-channel--workstation_queue) |
