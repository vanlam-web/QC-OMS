...
> Ranh giới MVP: Combo/BOM chỉ trừ vật tư thành phần khi BOM đã đủ cấu hình. Deep-scan combo lồng nhau và lưu combo mới từ POS là hướng sau MVP; chi tiết xem draft `docs/superpowers/specs/2026-07-01-bom-combo-mvp-boundary-draft.md`.
...
4. **Trừ kho khi chốt đơn:** Hàng thường/m²/tấm trừ kho theo Business Inventory. Combo chỉ trừ vật tư con nếu BOM đủ cấu hình; nếu chưa đủ thì lưu snapshot và cảnh báo. *(Backend xử lý — chi tiết thuộc tầng Business)*
...
7. **Deep-Scan khi thanh toán:** Không bắt buộc trong MVP. Chỉ bật khi phase BOM sau này đã chốt cấu hình, version và chống vòng lặp.
