...
> **Ranh giới MVP:** Phần Combo/BOM dưới đây là ý tưởng UX giàu để tham khảo. MVP chỉ bắt buộc lưu snapshot dòng combo trong chứng từ. Trừ vật tư thành phần chỉ áp dụng khi BOM đã đủ cấu hình; `Lưu Combo mới`, combo lồng nhau và deep-scan để sau phase BOM.
...
| Tùy chọn                                 | Hành vi                                                                                                                       |
| ---------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `[Không lưu — Chỉ trừ kho]` *(Mặc định)* | MVP hiểu là chỉ lưu snapshot cấu trúc trong chứng từ; chỉ trừ vật tư lẻ nếu BOM đã đủ cấu hình. Không làm ảnh hưởng định mức chuẩn của mã Combo gốc trong danh mục. |
| `[Lưu Combo mới]`                        | Sau MVP. Nếu làm, phải đi qua nghiệp vụ quản trị danh mục/BOM, không tự tạo SKU mới âm thầm từ POS.                         |
...
| Tùy chọn                    | Hành vi                                                                                                                                                                                               |
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `[Lưu Combo mới]`           | Sau MVP. Nếu cần lưu thành mặt hàng Combo mới, phải có spec quản trị danh mục/BOM riêng.                                                                                                             |
| `[Không lưu — Chỉ trừ kho]` | MVP hiểu là sản phẩm gia công phát sinh **1 lần duy nhất** và lưu snapshot trong chứng từ. Chỉ trừ vật tư lẻ khi BOM đủ cấu hình; nếu chưa đủ thì cảnh báo và không sinh mã sản phẩm Combo mới. |
