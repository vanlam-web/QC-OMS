...
| Tùy chọn                                 | Hành vi                                                                                                                       |
| ---------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `[Không lưu — Chỉ trừ kho]` *(Mặc định)* | Chỉ áp dụng cấu trúc bóc tách để trừ kho lẻ khi chốt đơn. Không làm ảnh hưởng định mức chuẩn của mã Combo gốc trong danh mục. |
| `[Lưu Combo mới]`                        | Yêu cầu gõ tên biến thể mới → lưu thành một mã Combo độc lập trong danh mục sản phẩm.                                         |
...
| `[Không lưu — Chỉ trừ kho]` | Sản phẩm gia công phát sinh **1 lần duy nhất**. Chốt đơn → trừ kho chính xác từng con ốc, mét led, tấm alu lẻ — nhưng **không sinh mã sản phẩm Combo mới** nào trong danh mục, tránh làm rác dữ liệu. |
