...
- module bar chính chỉ chứa các khu vực quản lý như `Chứng từ`, `Khách hàng`, `Hàng hóa`, `Bảng giá`, `Nhà cung cấp`, `Nhập hàng`, `Quản trị`; route nội bộ vẫn là `/sales-documents`
