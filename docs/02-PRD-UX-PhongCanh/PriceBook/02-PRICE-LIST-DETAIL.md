...
```text
[Nhóm hàng: Fomex] [Tên chứa: 5mm] [Mã chứa: F5] [Cách bán: tấm]
...
- Tên hàng hoặc mã hàng có thể dùng để lọc thêm theo cách nhân viên quen tìm.
- Tên/mã hàng chỉ dùng làm điều kiện duy nhất khi thật sự cần một rule rất hẹp; mặc định nên kết hợp với nhóm hàng để tránh bắt nhầm sản phẩm.
