...
| Empty | Hiển thị trạng thái trống trong vùng bảng, kèm nút tạo mới nếu có quyền |
| Filter empty | Báo không có kết quả với bộ lọc hiện tại, cho phép xóa lọc |
| Error | Banner lỗi ở vùng workspace, có nút thử lại |
| Permission denied | Ẩn nút hành động, nếu truy cập trực tiếp thì hiển thị thông báo không có quyền |
