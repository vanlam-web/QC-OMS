...
| Governance/docs cleanup | Quy trình 3 luồng rõ ràng, không để Owner chuyển lời | Review | Review | Waiting Review | PR #42 `codex/docs-governance-index-cleanup` | Review re-check docs cleanup and coordination mechanism |
