...
- Mở lại báo giá, sửa/hủy hóa đơn đã chốt và đảo kho/tiền/công nợ là năng lực future phase. Chỉ bật khi có transaction an toàn, rule nghiệp vụ rõ và test đủ cho các bảng liên quan.
