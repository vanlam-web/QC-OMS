...
Nháp POS Phase 2 vẫn lưu cục bộ theo trình duyệt/thiết bị đang thao tác tại `POS/ARCHITECTURE.md`. Backend không tạo bản ghi `orders` cho nháp cho đến khi nhân viên lưu báo giá hoặc checkout thành công.
