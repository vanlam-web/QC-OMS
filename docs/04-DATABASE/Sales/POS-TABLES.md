...
Hóa đơn nháp POS Phase 2 vẫn lưu local theo trình duyệt/thiết bị đang thao tác, không tạo bản ghi `orders` cho đến khi nhân viên lưu báo giá hoặc checkout thành công.
